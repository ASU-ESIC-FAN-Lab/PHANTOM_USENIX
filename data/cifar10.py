# Description: CIFAR-10 data loader
...
class Cifar10DataProvider():
    ...
    def __init__(self, save_path=None, train_batch_size=256, test_batch_size=256, valid_size=None,
        ...
        train_dataset = CIFAR10(self._save_path, train=True, transform=train_transforms)
        ...
        if valid_size is not None:
            ...
            print("Train size: %d, Valid size: %d" % (len(train_indexes), len(valid_indexes)))
            ...
            valid_dataset = datasets.CIFAR10(self._save_path, transform=valid_transforms)
            ...
            print("Train size: %d, Valid size: %d" % (len(self.train), len(self.valid)))
        ...
        test_dataset = CIFAR10(self._save_path, train=False, transform=test_transforms)
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = 'cifar10data/cifar-10-batches-py'
    ...
    @property
    def normalize(self):
        return transforms.Normalize(mean=[0.4914, 0.4822, 0.4465], std=[0.2471, 0.2435, 0.2616])
...
if __name__ == '__main__':
    ...
    cifar10 = Cifar10DataProvider("./", train_batch_size=1024, test_batch_size=1024, valid_size=1024, n_worker=32, distort_color='None')
