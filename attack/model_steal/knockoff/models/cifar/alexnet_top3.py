...
#     nn.Conv2d(32, 32, kernel_size=5, stride=1, padding=2, bias=False),
#     nn.Conv2d(32, 32, kernel_size=7, stride=1, padding=3, bias=False),
#     IdentityLayer(32, 32),
#     IdentityLayer(32, 32),
#     nn.Conv2d(32, 32, kernel_size=1, stride=1, bias=False),
#     nn.Conv2d(96, 96, kernel_size=3, stride=1, padding=1, bias=False),
#     nn.Conv2d(96, 96, kernel_size=3, stride=1, padding=1, bias=False),
#     nn.Conv2d(96, 96, kernel_size=7, stride=1, padding=3, bias=False),
#     nn.Conv2d(96, 96, kernel_size=3, stride=1, padding=1, bias=False),
#     nn.Conv2d(96, 96, kernel_size=3, stride=1, padding=1, bias=False),
#     nn.Conv2d(96, 96, kernel_size=5, stride=1, padding=2, bias=False),
#     nn.Conv2d(192, 192, kernel_size=3, stride=1, padding=1, bias=False),
#     nn.Conv2d(192, 192, kernel_size=1, stride=1, bias=False),
#     nn.Conv2d(192, 192, kernel_size=3, stride=1, padding=1, bias=False),
#     nn.Conv2d(192, 192, kernel_size=1, stride=1, bias=False),
#     nn.Conv2d(192, 192, kernel_size=1, stride=1, bias=False),
#     nn.Conv2d(192, 192, kernel_size=7, stride=1, padding=3, bias=False),
# ]
